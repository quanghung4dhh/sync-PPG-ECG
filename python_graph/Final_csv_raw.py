...
# --- CẤU HÌNH ---
CSV_FILENAME = 'data3.csv'  # Đảm bảo tên file đúng
...
def update(frame):
    ...
    for _ in range(samples_to_process):
        ...
        # PPG Plot
        red_data.append(raw_red)
        ir_data.append(raw_ir)
